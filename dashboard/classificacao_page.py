    ...
    return html.Div([
        dbc.Row([
            dbc.Col([
                ...
                html.P("Descubra o potencial do seu projeto na Cauda Longa. Este modelo calcula a probabilidade do seu filme alcançar o status de Sucesso de Crítica (Nota Média / vote_average ≥ 7.0 no IMDb).", className="text-muted fs-5"),
            ], width=12)
        ], className="mb-4"),
        ...
        dbc.Row([
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardHeader(html.H5("Impacto do Orçamento na Chance de Sucesso (Nota ≥ 7.0)", className="mb-0 text-primary fw-bold")),
                    dbc.CardBody([
                        dcc.Loading(
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    dbc.CardHeader(html.H5("Quais Gêneros têm mais chance de bater a Nota 7.0?", className="mb-0")),
                    dbc.CardBody([
                        dcc.Loading(
                            type="dot", color="#212529",
